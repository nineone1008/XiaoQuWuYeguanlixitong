 ...
 * 电卡管理面板
 */
public class ZrzElectricCardPanel extends JPanel {
    ...
    private JTextField txtAmount, txtKwh;

    public ZrzElectricCardPanel() {
    ...
    private void initComponents() {
        ...
        JLabel lblKwh = new JLabel("电量(度):");
        lblKwh.setForeground(Color.WHITE);
        lblKwh.setFont(new Font("微软雅黑", Font.BOLD, 13));
        topPanel.add(lblKwh);
        txtKwh = new JTextField(10);
        txtKwh.setFont(new Font("微软雅黑", Font.PLAIN, 13));
        topPanel.add(txtKwh);
        ...
        // 中间表格
        String[] columns = {"记录ID", "房号", "姓名", "购买金额", "电量(度)", "购买日期", "操作员"};
    ...
    private void loadData() {
        ...
        List<ZrzElectricCard> list = cardService.getAllElectricCards();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        
        for (ZrzElectricCard card : list) {
    ...
    private void purchaseCard() {
        ...
        try {
            ...
            ZrzDialogUtil.showMessageDialog(this, "金额或电量格式不正确！", "错误", JOptionPane.ERROR_MESSAGE);
        }
    }
