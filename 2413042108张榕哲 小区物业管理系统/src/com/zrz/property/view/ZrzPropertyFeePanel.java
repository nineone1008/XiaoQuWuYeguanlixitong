 ...
 * 物业费管理面板
 */
public class ZrzPropertyFeePanel extends JPanel {
    private ZrzFeeService feeService = new ZrzFeeService();
    private JTable table;
    private DefaultTableModel tableModel;

    public ZrzPropertyFeePanel() {
    ...
    private void initComponents() {
        ...
        // 中间表格
        String[] columns = {"费用ID", "房号", "姓名", "年份", "月份", "应缴金额", "已缴金额", "缴费状态", "应缴日期", "实缴日期", "逾期天数"};
    ...
    private void loadData() {
        ...
        List<ZrzPropertyFee> list = feeService.getAllPropertyFees();
    ...
    private void payFee() {
        ...
        BigDecimal amount = (BigDecimal) tableModel.getValueAt(row, 5);
        ...
        if (input != null && !input.trim().isEmpty()) {
            try {
                ...
                if (feeService.payPropertyFee(feeId, payAmount)) {
